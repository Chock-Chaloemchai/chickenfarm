          ...
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="p_img/<?= $row['p_img'] ?>" width="50"></td>
                <td><?= $row['p_name'] ?></td>
                <td>
              ...
              <tr>
                <td colspan="3">
                  <a href="product_all.php" class="btn btn-success"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Continue
                    Shopping</a>
                </td>
                <td colspan="2"><b>Grand Total</b></td>
                <td><b>฿&nbsp;<?= number_format($grand_total,2); ?></b></td>
                <td>
                  <a href="checkout.php"class="btn btn-info <?= ($grand_total > 1) ? '' : 'disabled'; ?>"><i class="far fa-credit-card"></i>&nbsp;&nbsp;ยืนยันการสั่งซื้อ</a>
                </td>
              </tr>
            </tbody>
          </table>
